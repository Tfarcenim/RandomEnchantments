...
public class EnchantmentObsidianBuster extends Enchantment {
    ...
    public boolean isAllowedOnBooks() {
        return tools.enableObsidianBuster == EnchantmentConfig.EnumAccessLevel.NORMAL;
    }

    @Override
    public boolean canApply(ItemStack stack){
        return tools.enableObsidianBuster != EnchantmentConfig.EnumAccessLevel.DISABLED && super.canApply(stack);
    }
