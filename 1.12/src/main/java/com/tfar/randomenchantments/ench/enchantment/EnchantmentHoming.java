...
public class EnchantmentHoming extends Enchantment {
  ...
  public boolean isAllowedOnBooks() {
    return weapons.enableHoming == EnchantmentConfig.EnumAccessLevel.NORMAL;
  }

  @Override
  public boolean canApply(ItemStack stack){
    return weapons.enableHoming != EnchantmentConfig.EnumAccessLevel.DISABLED && super.canApply(stack);
  }
