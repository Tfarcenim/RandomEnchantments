...
import static tfar.randomenchants.RandomEnchants.ObjectHolders.*;
...
public class ClientEventHandler {
  ...
  public static void globaltravellertooltip(ItemTooltipEvent event) {
    ...
    if (nbt.contains(EnchantmentGlobalTraveler.GLOBAL_TRAVELER_KEY, 10)) {
      CompoundNBT global = nbt.getCompound(EnchantmentGlobalTraveler.GLOBAL_TRAVELER_KEY);
