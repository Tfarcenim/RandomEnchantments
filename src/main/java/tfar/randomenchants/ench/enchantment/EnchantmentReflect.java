...
import static tfar.randomenchants.RandomEnchants.ObjectHolders.REFLECT;
import static tfar.randomenchants.RandomEnchants.SHIELDS;
...
public class EnchantmentReflect extends Enchantment {
  ...
  public boolean canApplyAtEnchantingTable(ItemStack stack) {
    return Config.ServerConfig.reflect.get() != Config.Restriction.DISABLED && stack.getItem().isShield(stack, null);
  }

  @Override
  public boolean canApply(@Nonnull ItemStack stack){
    return Config.ServerConfig.reflect.get() != Config.Restriction.DISABLED && super.canApply(stack);
  }
