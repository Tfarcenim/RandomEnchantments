...
public class EnchantmentBackToTheChamber extends Enchantment {
  ...
  public boolean canApply(ItemStack stack){
    return Config.ServerConfig.backtothechamber.get() != Config.Restriction.DISABLED && super.canApply(stack);
  }
  ...
  public boolean canApplyAtEnchantingTable(ItemStack stack) {
    return Config.ServerConfig.backtothechamber.get() != Config.Restriction.DISABLED && super.canApplyAtEnchantingTable(stack);
  }
