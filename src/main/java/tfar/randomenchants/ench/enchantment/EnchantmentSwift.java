...
public class EnchantmentSwift extends Enchantment {
  ...
  public boolean canApply(ItemStack stack){
    return Config.ServerConfig.swift.get() != Config.Restriction.DISABLED && super.canApply(stack);
  }

  @Override
  public boolean canApplyAtEnchantingTable(ItemStack stack) {
    return Config.ServerConfig.swift.get() != Config.Restriction.DISABLED && super.canApplyAtEnchantingTable(stack);
  }

  @Override
  public boolean isAllowedOnBooks() {
    return Config.ServerConfig.swift.get() == Config.Restriction.NORMAL;
  }

  @Override
  public boolean isTreasureEnchantment() {
    return Config.ServerConfig.swift.get() == Config.Restriction.ANVIL;
  }
  ...
  public static void onPlayerUpdate(TickEvent.PlayerTickEvent event) {
    ...
    if (!EnchantUtils.hasEnch(player, RandomEnchants.ObjectHolders.SWIFT)) return;
        int swing = ObfuscationReflectionHelper.getPrivateValue(LivingEntity.class,player,"field_184617_aD");
        swing+=getMaxEnchantmentLevel(RandomEnchants.ObjectHolders.SWIFT, player);
