...
import static tfar.randomenchants.RandomEnchants.ObjectHolders.TORCHES;
...
public class EnchantmentTorches extends Enchantment {
  ...
  public boolean canApply(ItemStack stack) {
    return Config.ServerConfig.torches.get() != Config.Restriction.DISABLED && super.canApply(stack);
  }

  @Override
  public boolean canApplyAtEnchantingTable(ItemStack stack) {
    return Config.ServerConfig.torches.get() != Config.Restriction.DISABLED && super.canApplyAtEnchantingTable(stack);
  }
