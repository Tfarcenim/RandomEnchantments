...
import static tfar.randomenchants.RandomEnchants.ObjectHolders.EQUAL_MINE;
...
public class EnchantmentEqualMine extends Enchantment {
  ...
  public boolean canApply(@Nonnull ItemStack stack){
    return Config.ServerConfig.equalmine.get() != Config.Restriction.DISABLED && super.canApply(stack);
  }

  @Override
  public boolean isTreasureEnchantment() {
    return Config.ServerConfig.equalmine.get() == Config.Restriction.ANVIL;
  }

  @Override
  public boolean canApplyAtEnchantingTable(ItemStack stack) {
    return Config.ServerConfig.equalmine.get() != Config.Restriction.DISABLED && super.canApplyAtEnchantingTable(stack);
  }

  @Override
  public boolean isAllowedOnBooks() {
    return Config.ServerConfig.equalmine.get() == Config.Restriction.NORMAL;
  }
