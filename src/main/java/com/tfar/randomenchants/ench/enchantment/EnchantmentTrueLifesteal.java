...
public class EnchantmentTrueLifesteal extends Enchantment {
  ...
  public boolean canApply(ItemStack stack){
    return Config.ServerConfig.true_lifesteal.get() != DISABLED && super.canApply(stack);
  }

  @Override
  public boolean isTreasureEnchantment() {
    return Config.ServerConfig.true_lifesteal.get() == ANVIL;
  }

  @Override
  public boolean canApplyAtEnchantingTable(ItemStack stack) {
    return Config.ServerConfig.true_lifesteal.get() != DISABLED && super.canApplyAtEnchantingTable(stack);
  }

  @Override
  public boolean isAllowedOnBooks() {
    return Config.ServerConfig.true_lifesteal.get() == NORMAL;
  }
